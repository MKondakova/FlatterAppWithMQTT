...
export class Initial1665086789244 implements MigrationInterface {
    name = 'Initial1665086789244'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sensor" ("id" SERIAL NOT NULL, "guid" uuid NOT NULL, "state" text NOT NULL DEFAULT '', CONSTRAINT "PK_ccc38b9aa8b3e198b6503d5eee9" PRIMARY KEY ("id"))`);
